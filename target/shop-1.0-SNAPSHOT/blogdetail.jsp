                            ...
                            <div class="aa-blog-content aa-blog-details">
                                <article class="aa-blog-content-single">
                                    ...
                                    <figure class="aa-blog-img">
                                        <a href="#"><img src="<c:url value="/templatesecond/img/fashion/3.jpg"/>" alt="fashion img"></a>
                                    </figure>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <div class="media-left">
                                                        <img class="media-object news-img" src="<c:url value="/templatesecond/img/fashion/3.jpg"/>" alt="img">
                                                    </div>
                                ...
                                <div id="respond">
                                    ...
                                    <form id="commentform">
                                        ...
                                        <p class="comment-form-author">
                                            <%--@declare id="author"--%><label for="author">Name <span class="required">*</span></label>
                                            <input type="text" name="author" value="" size="30" required="required">
                                        </p>

                                        <p class="comment-form-email">
                                            <%--@declare id="email"--%><label for="email">Email <span class="required">*</span></label>
                                            <input type="email" name="email" value="" aria-required="true" required="required">
                                        </p>
                                        <p class="comment-form-url">
                                            <%--@declare id="url"--%><label for="url">Website</label>
