...
<%@ page import="com.buiminhduc.repository.SanPhamRepository" %>
<%@ page import="com.buiminhduc.repository.impl.SanPhamRepositoryImpl" %>
                    ...
                    <div class="cart-view-table aa-wishlist-table">
                        ...
                        <form action="">
                            <div class="table-responsive">
                                <%
                                    SanPhamRepository product = new SanPhamRepositoryImpl();
                                    List<SanPhamEntity> ds = product.findAll();
                                %>
                                <table class="table">
                                    <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><a class="remove" href="/admin/managerProduct?id=<%=ds.get(i).getId()%>"><fa class="fa fa-close"></fa></a></td>
