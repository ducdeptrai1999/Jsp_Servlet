...
public class SanPhamEntity {
    ...
    public SanPhamEntity(String tenSanPham, String hinhAnh, String thongTinChiTiet, Integer giaBan, Integer soLuong, String mauSac, String tag, String trangThai, Integer idMenuCon) {
        this.tenSanPham = tenSanPham;
        this.hinhAnh = hinhAnh;
        this.thongTinChiTiet = thongTinChiTiet;
        this.giaBan = giaBan;
    ...
    public SanPhamEntity(Integer id, String tenSanPham, String hinhAnh, String thongTinChiTiet, Integer giaBan, Integer soLuong, String mauSac, String tag, String trangThai, Integer idMenuCon) {
        this.id = id;
        this.tenSanPham = tenSanPham;
        this.hinhAnh = hinhAnh;
        this.thongTinChiTiet = thongTinChiTiet;
